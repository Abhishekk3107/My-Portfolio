    ...
    <section id="hero" className="min-h-[80vh] flex items-center justify-center relative overflow-hidden py-12">
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <img id="profile-image" src={data.personal.image} alt="Profile" className="w-36 md:w-44 h-36 md:h-44 rounded-full mx-auto object-cover border-4 border-accent shadow-2xl" onError={(e)=>{e.currentTarget.src='/assets/images/user0.jpg'}} />
