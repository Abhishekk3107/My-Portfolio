    ...
    ScrollTrigger.create({
      ...
      onEnter: () => {
        if (!isAnimated) {
          ...
          // Animate skill bars with proper timing
          const allSkills = Object.keys(skillProficiency)
                        ...
                        {skills.map((skill) => (
                          <div key={skill}>
                            ...
                            <div className="relative h-3 bg-[rgba(255,255,255,0.05)] rounded-full overflow-hidden">
                              <div 
                                className="h-full bg-gradient-to-r from-accent to-accent/80 rounded-full transition-all duration-1000 ease-out relative overflow-hidden"
                                style={{ 
                              ...
                              {/* Glow effect */}
                              <div 
                                className="absolute top-0 h-full bg-accent/30 rounded-full blur-sm transition-all duration-1000"
                                style={{ 
                                  width: `${skillLevels[skill] || 0}%`,
                                  transition: 'width 1000ms ease-out'
                                }}
